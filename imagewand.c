...
{
    struct image img2;
    img2.gray_Data = malloc(h2*w2*sizeof(unsigned char));
    img2.height = h2;
    img2.width = w2;
    ...
    for (int i = 0; i<h2; i++)
    {
        for (int j=0;j<w2;j++)
        {
            ...
            float del_x,del_y,del_x1,del_y1;
            
            del_x = height_Frac_Idx - height_idx;
            del_y = width_Frac_Idx - width_idx;
            del_x1 = 1.0f - del_x;
            del_y1 = 1.0f - del_y1;
        
            f1 = del_x1*del_y1*256.0f;
            f2 = del_x*del_y1*256.0f;
            f3 = del_x1*del_y*256.0f;
            f4 = del_y*del_x*256.0f;
...
int main(int argc,  char * argv[])
{
    ...
    for(int i=0;i<height2;i++)
    {
        ...
        for(int j=0;j<width2;j++)
        {
             ...
             */
            unsigned char temp_char = img_OP.gray_Data[(i*img_OP.width)+j];
